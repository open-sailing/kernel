...
static inline int vgic_v3_has_attr_regs(struct kvm_device *dev,
					struct kvm_device_attr *attr)
{
	return -ENODEV;
}

static inline int vgic_v3_dist_uaccess(struct kvm_vcpu *vcpu, bool is_write,
				       int offset, u32 *val)
{
	return -ENODEV;
}

static inline int vgic_v3_redist_uaccess(struct kvm_vcpu *vcpu, bool is_write,
					 int offset, u32 *val)
{
	return -ENODEV;
}

static inline int vgic_v3_cpu_sysregs_uaccess(struct kvm_vcpu *vcpu, bool is_write,
			 u64 id, u64 *val)
{
	return -ENODEV;
}
static inline int vgic_v3_has_cpu_sysregs_attr(struct kvm_vcpu *vcpu, bool is_write, u64 id,
				u64 *reg)
{
	return -ENODEV;
}

static inline int vgic_v3_line_level_info_uaccess(struct kvm_vcpu *vcpu, bool is_write,
				    u32 intid, u64 *val)
{
	return -ENODEV;
}
