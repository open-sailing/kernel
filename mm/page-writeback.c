...
static void wb_position_ratio(struct dirty_throttle_control *dtc)
{
	 ...
	 * two values: wb_dirty and bdi_thresh. Let's consider an example:
	 ...
	 * wb_dirty is under bdi_setpoint and vice versa.
	 *
	...
	if (unlikely(wb->bdi->capabilities & BDI_CAP_STRICTLIMIT)) {
		 ...
		 * wb's) while given strictlimit BDI is below limit.
		 *
		 ...
		 * (when globally we are at freerun and bdi is well below wb
