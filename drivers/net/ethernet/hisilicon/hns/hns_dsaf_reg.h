...
#define DSAF_SW_PORT_MAC_NUM	6
#define DSAF_SW_PORT_PPE_IDX	6
#define DSAF_SW_PORT_ROCEE_IDX	7
...
#define DSAF_SUB_SC_RCB_2X_CLK_EN_REG                  0x378
#define DSAF_SUB_SC_RCB_2X_CLK_DIS_REG                 0x37c
...
#define DSAF_SUB_SC_RCB_2X_RESET_REQ_REG               0xAC0
#define DSAF_SUB_SC_RCB_2X_RESET_DREQ_REG              0xAC4
...
#define RCB_RING_TO_BE_RST			0x00094
...
#define DSAF_INODE_NO_VLAN_DATA_TC_S 27
#define DSAF_INODE_NO_VLAN_DATA_TC_M (3ULL << DSAF_INODE_NO_VLAN_DATA_TC_S)
#define DSAF_INODE_NO_VLAN_MAN_TC_S 24
#define DSAF_INODE_NO_VLAN_MAN_TC_M (3ULL << DSAF_INODE_NO_VLAN_MAN_TC_S)
#define DEFAULT_INODE_NO_VLAN_DATA_TC (1)
#define DEFAULT_INODE_NO_VLAN_MAN_TC (0)

#define HNS_DSAF_I4TC_CFG 0x18053053
/* the Pri to TC is 4/0/7/6/5/3/2/1  */
#define HNS_DSAF_I8TC_CFG 0x1829DDC4
...
#define DSAF_SBM_CFG2_ROCEE_SET_BUF_NUM_S 0
#define DSAF_SBM_CFG2_ROCEE_SET_BUF_NUM_M (((1ULL << 8) - 1) << 0)
#define DSAF_SBM_CFG2_ROCEE_RESET_BUF_NUM_S 8
#define DSAF_SBM_CFG2_ROCEE_RESET_BUF_NUM_M (((1ULL << 8) - 1) << 8)
...
#define DSAF_SBM_CFG2_PPE_SET_BUF_NUM_S (0)
#define DSAF_SBM_CFG2_PPE_SET_BUF_NUM_M (((1ULL << 6) - 1) << 0)
#define DSAF_SBM_CFG2_PPE_RESET_BUF_NUM_S (6)
#define DSAF_SBM_CFG2_PPE_RESET_BUF_NUM_M (((1ULL << 6) - 1) << 6)
#define DSAF_SBM_CFG2_PPE_CFG_USEFUL_NUM_S (12)
#define DSAF_SBM_CFG2_PPE_CFG_USEFUL_NUM_M (((1ULL << 6) - 1) << 12)
...
#define INVALID_VIRQ (-1)
#define INVALID_INT_INDEX 0xFFFFFF

#define XGE_XBAR_NUM (6)
#define PPE_XBAR_NUM (6)

#define REG_STEP_SHIFT (2U)
...
#define net_dev_err(dev, port, X, ARGS...) \
	do {	\
