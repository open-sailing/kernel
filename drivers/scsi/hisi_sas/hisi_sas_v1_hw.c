 ...
 */
static int get_free_slot_v1_hw(struct hisi_hba *hisi_hba,
...
static void start_delivery_v1_hw(struct hisi_hba *hisi_hba, int dq_id)
{
...
static int get_phy_state_v1_hw(struct hisi_hba *hisi_hba, int phy_id)
{
	u32 phy_state = hisi_sas_read32(hisi_hba, PHY_STATE);
...
static const struct hisi_sas_hw hisi_sas_v1_hw = {
	...
	.get_phy_state = get_phy_state_v1_hw,
