 ...
 */
static void __maybe_unused
rcu_adopt_orphan_cbs(struct rcu_state *rsp, unsigned long flags)
{
	int i;
 ...
 * There can only be one CPU hotplug operation at a time, so no other CPU
 * can be attempting to update rcu_cpu_kthread_task.
 */
