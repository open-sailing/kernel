...
#define COMPAT_SYSCALL_WRAP1(name, ...) COMPAT_SYSCALL_WRAPx(1, _##name,\
							     __VA_ARGS__)
#define COMPAT_SYSCALL_WRAP2(name, ...) COMPAT_SYSCALL_WRAPx(2, _##name,\
							     __VA_ARGS__)
#define COMPAT_SYSCALL_WRAP3(name, ...) COMPAT_SYSCALL_WRAPx(3, _##name,\
							     __VA_ARGS__)
#define COMPAT_SYSCALL_WRAP4(name, ...) COMPAT_SYSCALL_WRAPx(4, _##name,\
							     __VA_ARGS__)
#define COMPAT_SYSCALL_WRAP5(name, ...) COMPAT_SYSCALL_WRAPx(5, _##name,\
							     __VA_ARGS__)
#define COMPAT_SYSCALL_WRAP6(name, ...) COMPAT_SYSCALL_WRAPx(6, _##name,\
							     __VA_ARGS__)
...
asmlinkage long compat_sys##name(__MAP(x, __SC_DECL, __VA_ARGS__))	\
		__attribute__((alias(__stringify(compat_SyS##name))));	\
asmlinkage long notrace compat_SyS##name(__MAP(x, __SC_COMPAT_TYPE,	\
					       __VA_ARGS__));		\
asmlinkage long notrace compat_SyS##name(__MAP(x, __SC_COMPAT_TYPE,	\
					       __VA_ARGS__))		\
{									\
...
asmlinkage long compat_sys_sigsuspend(int unused1, int unused2,
				      old_sigset_t mask);
#endif

asmlinkage long compat_sys_sethostname(char __user *name, int len);
asmlinkage long compat_sys_symlink(const char __user *old,
...
asmlinkage long compat_sys_swapon(const char __user *specialfile,
				  int swap_flags);
...
asmlinkage long compat_sys_delete_module(const char __user *name_user,
					 unsigned int flags);
asmlinkage long compat_sys_quotactl(unsigned int cmd,
				    const char __user *special,
				    qid_t id, void __user *addr);
asmlinkage long compat_sys_bdflush(int func, long data);
asmlinkage long compat_sys_sysfs(int option, unsigned long arg1,
				 unsigned long arg2);
...
asmlinkage long compat_sys_sched_setscheduler(pid_t pid, int policy,
					      struct sched_param __user *param);
asmlinkage long compat_sys_mremap(unsigned long addr, unsigned long old_len,
				  unsigned long new_len, unsigned long flags,
				  unsigned long new_addr);
asmlinkage long compat_sys_poll(struct pollfd __user *ufds, unsigned int nfds,
				int timeout);
asmlinkage long compat_sys_prctl(int option, unsigned long arg2,
...
asmlinkage long compat_sys_getresuid(uid_t __user *ruid, uid_t __user *euid,
				     uid_t __user *suid);
asmlinkage long compat_sys_getresgid(gid_t __user *rgid, gid_t __user *egid,
				     gid_t __user *sgid);
...
asmlinkage long compat_sys_madvise(unsigned long start, size_t len,
				   int behavior);
asmlinkage long compat_sys_setxattr(const char __user *path,
				    const char __user *name,
				    const void __user *value, size_t size,
				    int flags);
asmlinkage long compat_sys_lsetxattr(const char __user *path,
				     const char __user *name,
...
asmlinkage long compat_sys_getdents64(unsigned int fd,
				      struct linux_dirent64 __user *dirent,
				      unsigned int count);
asmlinkage long compat_sys_getxattr(const char __user *path,
				    const char __user *name,
				    void __user *value, size_t size);
asmlinkage long compat_sys_lgetxattr(const char __user *path,
				     const char __user *name,
				     void __user *value, size_t size);
...
asmlinkage long compat_sys_listxattr(const char __user *path, char __user *list,
				     size_t size);
asmlinkage long compat_sys_llistxattr(const char __user *path,
...
asmlinkage long compat_sys_io_cancel(aio_context_t ctx_id,
...
asmlinkage long compat_sys_request_key(const char __user *_type,
				       ...
				       key_serial_t destringid);
asmlinkage long compat_sys_remap_file_pages(unsigned long start,
					    unsigned long size,
					    unsigned long prot,
					    unsigned long pgoff,
					    unsigned long flags);
asmlinkage long compat_sys_inotify_add_watch(int fd, const char __user *path,
					     u32 mask);
asmlinkage long compat_sys_mknodat(int dfd, const char __user *filename,
				   umode_t mode,
			    unsigned dev);
asmlinkage long compat_sys_mkdirat(int dfd, const char __user *pathname,
				   umode_t mode);
asmlinkage long compat_sys_fchownat(int dfd, const char __user *filename,
				    uid_t user, gid_t group, int flag);
asmlinkage long compat_sys_unlinkat(int dfd, const char __user *pathname,
				    int flag);
...
asmlinkage long compat_sys_linkat(int olddfd, const char __user *oldname,
				  int newdfd, const char __user *newname,
				  int flags);
asmlinkage long compat_sys_readlinkat(int dfd, const char __user *path,
				      char __user *buf, int bufsiz);
asmlinkage long compat_sys_fchmodat(int dfd, const char __user *filename,
				    umode_t mode);
asmlinkage long compat_sys_faccessat(int dfd, const char __user *filename,
				     int mode);
asmlinkage long compat_sys_unshare(unsigned long unshare_flags);
asmlinkage long compat_sys_splice(int fd_in, loff_t __user *off_in, int fd_out,
				  loff_t __user *off_out, size_t len,
				  unsigned int flags);
asmlinkage long compat_sys_tee(int fdin, int fdout, size_t len,
			       unsigned int flags);
asmlinkage long compat_sys_getcpu(unsigned __user *cpu, unsigned __user *node,
...
asmlinkage long compat_sys_clone(unsigned long, unsigned long, int,
				 int __user *, int __user *, int);
#else
asmlinkage long compat_sys_clone(unsigned long, unsigned long, int __user *,
				 int __user *, int);
#endif
...
asmlinkage long compat_sys_finit_module(int fd, const char __user *uargs,
					int flags);
...
asmlinkage long compat_sys_getrandom(char __user *buf, size_t count,
			      unsigned int flags);
asmlinkage long compat_sys_memfd_create(const char __user *uname_ptr,
					unsigned int flags);
asmlinkage long compat_sys_bpf(int cmd, union bpf_attr *attr,
			       unsigned int size);
...
asmlinkage long compat_sys_accept4(int, struct sockaddr __user *,
				   int __user *, int);
asmlinkage long compat_sys_getsockname(int, struct sockaddr __user *,
				       int __user *);
asmlinkage long compat_sys_getpeername(int, struct sockaddr __user *,
				       int __user *);
